      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold text-secondary">My Journey</h3>
          ...
          {/* Skills */}
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold text-secondary">Technical Skills</h3>
            
            <div className="space-y-4">
              <div>
                <h4 className="font-medium text-secondary mb-3">Frontend</h4>
              ...
              <div>
                <h4 className="font-medium text-secondary mb-3">Backend</h4>
                <div className="flex flex-wrap gap-2">
              ...
              <div>
                <h4 className="font-medium text-secondary mb-3">Cloud & Tools</h4>
                <div className="flex flex-wrap gap-2">
